...
//    static_cast<DependencyInstanceNumeric*>(instance);
    ...
    gettimeofday(&end_decoding, NULL);
    LOG(INFO) << "=========================================" <<endl;
    LOG(INFO) << "computing scores time is " << diff_ms(end_score_computing, start_score_computing)<< endl;
    LOG(INFO) << "computing decoding is " << diff_ms(end_decoding, start_decoding)<< endl;
    LOG(INFO) << "=========================================" <<endl;
